...
FALLBACK="\n\n## skyline transport\n\nThe local skyline HTTP daemon is not running and the user has previously declined installing it. Do NOT offer it again. Use the npmjs stdio server instead (skyline-npmjs-stdio, npx -y @skylence-ai/skyline mcp) for all skyline tool calls this session."
